	...
	DCalendar.prototype = {
		...
		create : function(){
			var that = this,
				...
				cardhead = $('<section class="calendar-head-card"><span class="calendar-date-wrapper" title="Select current date."><span class="calendar-dayofweek"></span>, <span class="calendar-month"></span> <span class="calendar-date"></span></span></section>'),
